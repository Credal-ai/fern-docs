To get the most accurate and helpful responses from Credal, it's essential to craft your prompts effectively.

Here's why prompt engineering matters:

1. **Improves Accuracy**: Well-crafted prompts lead to more precise and relevant answers, reducing the likelihood of misinterpretations or generic responses.
2. **Saves Time**: By clearly directing the AI, you can get the information you need in fewer attempts.
3. **Handles Complex Tasks**: Complex tasks require nuanced understanding. Good prompts help translate intricate questions into a form the AI can process effectively.
4. **Drives Innovation**: Mastering prompt engineering allows you to push the boundaries of AI applications, driving innovation and enabling new solutions to complex problems.

This guide provides the foundational understanding and practical steps to optimize your interactions with Credal for precise and valuable responses.

## 1. What is the Background Prompt

The [background prompt](/user-guide/platform/agent-builder/configuration/writing-instructions) is arguably the most effective way to customize your agent. It defines the environment in which your agent operates, detailing its role, response style, and the types of queries it should handle. Creating an effective background prompt ensures your agent seamlessly integrates into your specific use case.

## 2. Constructing a Background Prompt

### Role and Goal

Define the specific role your agent will fulfill. Include details such as:

- **Who**: The specific team or individual using the agent.
- **What**: The typical nature of queries or tasks it will address.
- **Where**: The operational context, such as customer service, technical support, etc.
...
LLMs can be unpredictable, but fortunately we can direct them with clear instructions. Providing a template for expected responses is one effective approach.
...
Create detailed instructions that anticipate potential pitfalls and standard operational procedures. Your agent will only know what you tell it. Are responses too long? Specify the desired length! Is the language too verbose? Ask for concise responses.
...
Utilize the most recent and capable [models](/user-guide/platform/agent-builder/configuration/choosing-a-model) to achieve the best results. Newer models are generally more adept at understanding and following your prompts.
