...
For a deeper walkthrough, see our [Detailed Agents User Guide](/user-guide/platform/agents).

1. **Metadata** – Name and Description are already set.
2. **Model** – Choose from the latest models across OpenAI, Anthropic, Google, and Cerebras. Cerebras is worth trying if speed is a priority — it runs open-source models on specialized hardware for significantly faster responses. If you're unsure, the default is a solid starting point.
...
This guide covers Slack. For other integrations, see the [full documentation](/user-guide/platform/agents/publishing-agents).
...
- **All relevant messages**: will respond to all queries matching the [Description](/user-guide/platform/agents/configure-an-agent/a-name-and-description) of the agent.
...
📘 Looking for a more in-depth guide? Refer to the [Agents Platform section](/user-guide/platform/agents)
