Credal's Bulk Analysis feature allows users to analyze a collection of documents or rows in a spreadsheet simultaneously using Credal agents. Use it to automatically extract fields from, classify, or synthesize multiple documents at once.
