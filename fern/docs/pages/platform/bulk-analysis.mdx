...
_This is a 20 minute guide to setting up and running a Bulk Analysis in Credal. Prerequisites are that you have read the [AI Agents User guide](user-guide/getting-started/agents/in-depth-guide)._
