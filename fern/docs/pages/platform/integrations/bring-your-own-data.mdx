...
AI Entity Extraction allows you to specify a predetermined set of values for a field in a schema, and have an **LLM auto extract these values** as we crawl data.
