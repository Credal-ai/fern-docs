Collection schemas describe the expected structure of a set of documents, or a set of entities that you’d want associated with each individual document for filtering purposes. Schemas are used by [Smart Filtering](/user-guide/platform/agent-builder/configuration/add-connectors/document-collections/smart-filtering-beta) to narrow search results to the most relevant documents.
