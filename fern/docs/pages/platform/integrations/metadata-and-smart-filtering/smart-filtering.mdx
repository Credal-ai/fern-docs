...
This is preconfigured automatically for the Salesforce and Jira data sources - but we recommend that you confirm that the types of these schemas are what you need for your usecase.
