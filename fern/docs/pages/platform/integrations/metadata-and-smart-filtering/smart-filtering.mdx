...
1. A [Collection Schema](/user-guide/platform/agent-builder/configuration/add-connectors/document-collections/collection-schemas) specified for your document collection.
