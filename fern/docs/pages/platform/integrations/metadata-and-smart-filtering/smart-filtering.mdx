...
1. A [schema](/user-guide/platform/agent-builder/configuration/add-connectors/document-collections/collection-schemas) specified for your document collection.
