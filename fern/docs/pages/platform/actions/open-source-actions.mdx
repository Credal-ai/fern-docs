...
Credal's Open Source Actions Framework lets you add custom [actions](/user-guide/platform/governed-actions/overview) to Credal Agents via LLM function calling. The full source lives at **[credal-ai/actions-sdk](https://github.com/credal-ai/actions-sdk)** — all contributions, bug reports, and feature requests should go there.
