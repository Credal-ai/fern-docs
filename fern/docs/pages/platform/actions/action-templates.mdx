...
3. Browse the [Open Source Actions](/user-guide/platform/governed-actions/open-source-actions) documentation for the open-source templates library, or view it directly on [GitHub](https://github.com/Credal-ai/actions-sdk)
