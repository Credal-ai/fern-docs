...
![admin-mcp-setup](/docs/assets/mcp-servers/publishing/admin-mcp-setup.png)

Once connected, all published MCP servers will be available to users in that service without any further configuration.

## Publishing Your Server

Once your MCP server is ready, you have two ways to deploy it.
...
![publish-to-claude-chatgpt](/docs/assets/mcp-servers/publishing/publish-to-claude-chatgpt.png)
...
![copy-server-url](/docs/assets/mcp-servers/publishing/copy-server-url.png)
...
![configure-allowlist](/docs/assets/mcp-servers/publishing/configure-allowlist.png)
