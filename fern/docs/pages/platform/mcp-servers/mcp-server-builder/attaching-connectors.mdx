...
Additionally, actions that require [human approval](/user-guide/platform/governed-actions/human-approval-options) are not permitted on MCP servers yet. Stay tuned for when this gets enabled!
