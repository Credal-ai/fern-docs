...
Then, in the agent configuration page, you can scroll to the and enter the name of the action you'd like to attach. The action will then be available to the agent.
