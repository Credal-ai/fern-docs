...
2. **Creativity** - You can set the level of creativity you want your agent to have by making a selection from the panel below. For most use cases, you’ll want “precise” or “balanced”. More creativity means the agent will try more unusual responses, while more precision means the agent will rely more on the context and data you provide. 
   The creativity setting is a bit like having an “eccentric genius” on the team: a lot of what it says may be off, but it’ll occasionally produce something really unique and interesting: most useful for marketing, brainstorming, or creative writing use cases.
