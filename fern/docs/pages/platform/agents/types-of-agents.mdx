...
This guide walks you through the definitions of each agent type, what you might use them for, and how to build them. The configuration process for each uses the same controls, but this guide helps you refine your building and problem decomposition process depending on where your use case falls.

## Domain Specialists

**Definition:**  
Domain Specialists are agents that understand your data and expertise extremely well. They're designed to handle specific questions within a particular domain, leveraging deep knowledge and insights to provide accurate and relevant outputs.
...
**Definition:**  
Operations Engines are agents that follow your detailed Standard Operating Procedures (SOPs) to carry out intricate, context-driven procedures. They're designed to automate and optimize operational workflows.
...
3. **Integration:** Ensure the agent can integrate with existing systems and data sources to execute tasks effectively. You'll likely consult a domain specialist for this!
...
By following these guidelines, you can effectively build and publish agents in Credal that are tailored to your enterprise's needs, ensuring they are both powerful and compliant.