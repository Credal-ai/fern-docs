...
Enable Suggested Questions in chat to display them at the chat start screen and above the input box during an active conversation. Users can click any card to auto-populate the prompt in one click, and collapse or expand the cards at any time using the toggle button above them.
