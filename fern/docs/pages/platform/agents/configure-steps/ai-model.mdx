...
Choose the foundation AI model your agent should use.
Credal supports models from **OpenAI, Anthropic, Google, and Cerebras**, though your organization or cloud environment may limit which providers or models are available. Reach out to support@credal.ai with questions.
...
More advanced models are usually more capable and more expensive. Consider:
...
**Tip:** Use the Preview tab to compare responses before publishing. For side-by-side tests across model configurations, see [Agent Benchmark](/user-guide/platform/agent-builder/evaluating-your-agent/agent-benchmark).

![agent-different-models-dropdown.png](/docs/assets/agents/create-steps/agent-different-models-dropdown.png)

Credal helps you compare models with:

- Model descriptions
- Preview testing
- Team recommendations

If you need a model that is not listed, reach out and we can look into adding it.
