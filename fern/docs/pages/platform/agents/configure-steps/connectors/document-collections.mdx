...
[Smart Filtering](/user-guide/platform/agent-builder/configuration/add-connectors/document-collections/smart-filtering-beta) lets your agent use document metadata and auto-extracted entities to filter out to the most relevant documents, sending only the most relevant content to the LLM, improving precision and reducing noise.
...
2. Setup your document collection with a [metadata schema](/user-guide/platform/agent-builder/configuration/add-connectors/document-collections/collection-schemas):
