...
- In the dialog that appears, fill in:
  ...
  - Description — Add a short description of what kind of content the collection holds. This description is shown to agents with Smart Filtering enabled, helping them choose which collections to query and when to query them based on the user's question.
