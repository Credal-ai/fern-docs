...
If you have published your agent to Slack, when you “👎” a response, you will have the option to add a suggested answer. Your agent will learn from this answer, enabling it to better respond to future similar queries.
