...
2. Enable the **Callable** toggle to make your agent available as a tool

   <!-- TODO: Add screenshot of agent publish toggle -->
...
3. Configure access permissions:
   ...
   **Option 2: Specific Callers**
   ...
   <!-- TODO: Add screenshot of agent access control options -->
...
<!-- TODO: Add screenshot of adding agent to MCP server -->
