...
Credal agents can be told to decide when to response. They only make this decision when responding to the thread owner and will ignore messages from other participants in the conversation. This feature is in beta so please reach out with any feedback, questions, or requests!
