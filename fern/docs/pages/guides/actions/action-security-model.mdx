...
| Edit / Delete / Share the Action? | Action Collaborator | Action Collaborator | Admin, until we have version control for Actions³ | Admin, until we have version control for Actions³ |
