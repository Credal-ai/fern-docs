...
| --------------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------- |
| **User OAuth / Personal API keys / Basic Auth / Credal Native** | Salesforce, Credal enterprise search, Jamf, Kanji | In the provider's implementation                            |
| **Action Scoped Auth**                                     | Snowflake                                         | In the provider's implementation                            |
| **Org-level Auth w/ Permissions Supported**                     | Slack, MongoDB, Gong                              | In Credal's implementation of interfacing with provider API |
| **Org-level Auth w/ Permissions Unavailable**                   | Looker, Snowflake (Formerly Kanji & Jamf)         | ²Trusted allowlist defined in action                        |
