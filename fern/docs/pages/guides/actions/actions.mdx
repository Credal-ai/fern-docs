...
3. You can find the open source templates library here: https://github.com/Credal-ai/actions (currently private, will be made public very soon...)
...
5. You can connect any action automatically, however any copilot connection action will require approval: [Read more here](/copilots/copilot-collaboration)

6. Now your copilot can call on actions! It will do this automatically if it's the best action to take
