...
![*Here, the Agent responded as the question fell within the its scope—questions on information security at Credal.*](/docs/assets/copilots/slack_relevant_query_response.png)

_Here, the Agent responded as the question fell within the its scope—questions on information security at Credal._
