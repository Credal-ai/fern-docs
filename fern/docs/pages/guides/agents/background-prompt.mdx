...
information at a specific point, or look at specific data before making a decision, you can specify that all here. See ![attaching actions to agents](/docs/pages/guides/agents/attaching-actions.mdx) for an example of what this should look like.
