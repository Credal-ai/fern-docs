...
| Data Source                    | Permissions aware connector status                       |
| ------------------------------ | -------------------------------------------------------- |
| Slack                          | Fully supported                                          |
| Confluence                     | Fully supported                                          |
| Google Drive/Docs/Sheets/Slides| Fully supported                                          |
| Microsoft SharePoint, OneDrive | Fully supported                                          |
| Salesforce                     | Fully supported                                          |
| Zendesk                        | Fully supported                                          |
| Intercomm                      | Fully supported                                          |
| MongoDB                        | Fully supported (perms not applicable)                   |
| Web Pages                      | Fully supported  (perms not applicable)                              |
| Notion                         | Public Within Your Organization (Notion API Limitations) |
| Asana                          | Fully supported                                          |
| Snowflake                      | Fully supported                                          |
| Jira                           | Fully supported                                          |
| Looker                         | Fully supported                                          |
