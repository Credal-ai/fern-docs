...
This guide will walk you through the definitions of each Agent, what you might use them for, and how to build them. The configuratin process for each has the same toggles, but this guide is meant to help you refine your building and decomp process depending on where it falls.
