...
Copilots allow users to create dedicated assistants that can be honed in on specific use cases and tasks.

With copilots calling copilots you can open up the space for more complex queries and responses.
...
_To allow your copilot to be called by other copilots, you need to change it's discoverability settings._

To get started:

1. On your left sidebar, Select “Copilots”:

![copilots_lhs](/docs/assets/copilots/copilots-calling-copilots/credal-side-bar.png)

2. Select the copilot you want to set as discoverable by clicking it.

![copilots_table](/docs/assets/copilots/copilots-calling-copilots/copilots-table.png)

3. Navigate to the Deploy tab and enable the `Allow other Copilots to call this Copilot` option.

![copilot_deploy_tab](/docs/assets/copilots/copilots-calling-copilots/copilots-deploy.png)
...
1. Navigate to the Confirguration tab of the copilot you want calling other copilots and scroll down to Actions.

![copilot_actions_tab](/docs/assets/copilots/copilots-calling-copilots/copilots-actions.png)

2. Search for the compilot you want to connect to, the action will be called `Consult [copilot name]`.

![copilot_connection_via_actions](/docs/assets/copilots/copilots-calling-copilots/copilots-add-copilot.png)

3. Once you request to connect it you'll be put in a `Pending Approval` state until the copilot you request approves you.

![copilot_pending_approval](/docs/assets/copilots/copilots-calling-copilots/copilots-action-copilot-pending.png)
...
![copilot_handle_approvals](/docs/assets/copilots/copilots-calling-copilots/copilots-handle-approvals.png)
...
![copilot_connection_via_actions](/docs/assets/copilots/copilots-calling-copilots/copilots-remove-connection.png)
...
Requests will automatically be routed to the available copilot connection that fits your request best, you will see this in action on the chat page which will show copilot to copilot requests. 
