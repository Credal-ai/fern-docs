...
More advanced models, like GPT-4, are both more expensive and more capable than earlier models. When selecting a model, you may want to consider your budget, the volume of queries you expect the copilot to receive, and the complexity of the task.

![model_selection.png](/docs/assets/copilots/copilot_description.png)
...
2. **Smart Filtering**
   ...
   To use Smart Filtering, there are two prerequisites:
...
### a. **Using copilots through Credal**
...
### b. Using copilots through t**hird party applications**
