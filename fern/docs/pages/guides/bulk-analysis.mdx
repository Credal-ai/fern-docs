Credal’s Bulk Analysis feature allows users to analyze on a collection of documents or rows in a spreadsheet simultaneously, using LLMs or Credal Copilots. Use it to automatically extract fields from, classify or synthesize multiple documents simultaneously.
...
**Copilot:** Special-purpose AI assistant with a use case specific foundation model, connected data sources, and custom prompt
...
![include-full-contents.png](/docs/assets/bulk-analysis/in-depth-guide/include-full-contents.png)

Click on “Add User input” at the bottom right of this section and you will be prompted like so:

![create-user-input.png](/docs/assets/bulk-analysis/in-depth-guide/create-user-input.png)
...
![populated-suggested-questions.png](/docs/assets/bulk-analysis/in-depth-guide/populated-suggested-questions.png)
...
![link-a-collection-or-spreadsheet.png](/docs/assets/bulk-analysis/in-depth-guide/link-a-collection-or-spreadsheet.png)
...
![document-collection.png](/docs/assets/bulk-analysis/in-depth-guide/document-collection.png)
...
![link-a-data-source.png](/docs/assets/bulk-analysis/in-depth-guide/link-a-data-source.png)
...
![BA-preview.png](/docs/assets/bulk-analysis/in-depth-guide/BA-preview.png)
