...
For this we can create a generic **runSnowflakeQuery** Action with all parameters predefined, where the query parameter is a a simple query:
```sql
...
### Need Help?
The Snowflake Actions is a powerful tool - if you have any questions or need help feel free to reach out to us at contact support@credal.ai.
