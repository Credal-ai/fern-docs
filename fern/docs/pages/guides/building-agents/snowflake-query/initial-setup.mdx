...
8. **Code Interpreter Limit** (Optional): The minimum number of rows required to pass to code interpreter for analysis (thinking models handle small sets of results better than code interpreter)
...
We recommend using a thinking model with reasoning enabled such as o3 or Claude 3.7 
