...
####If deploying directly in the #onboarding channel:

* Skip creating the Slack message Action
* Instead, modify your instructions to have the assistant tag SMEs directly in its responses
