...
- **Real-time Deprovisioning** - Immediately revoke access when users leave your organization (all actions are captured in the [Audit Log](/user-guide/platform/administration/audit-log-data-exports))
