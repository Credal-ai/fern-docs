...
| 3rd Party MCP Registry | `/api/gateway/[mcpServerId]/mcp`        | Not currently supported. [Contact us](https://www.credal.ai/contact) if you're interested in proxying external third-party MCP servers through Credal                             |
