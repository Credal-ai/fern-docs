...
| 3rd Party MCP Registry | `/api/gateway/[mcpServerId]/mcp`        | Coming soon. [Contact us](mailto:support@credal.ai) if you're interested in proxying external third-party MCP servers through Credal                             |
