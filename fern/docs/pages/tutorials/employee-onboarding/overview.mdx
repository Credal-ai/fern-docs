...
1. [Answer Basic Questions](/user-guide/getting-started/tutorials-common-first-agents/employee-onboarding-assistant/answer-basic-questions)
2. [Searching Internal and External Knowledge](/user-guide/getting-started/tutorials-common-first-agents/employee-onboarding-assistant/searching-internal-and-external-knowledge)
3. [Connect with Internal Systems](/user-guide/getting-started/tutorials-common-first-agents/employee-onboarding-assistant/connect-with-internal-systems)

Ready to build Version 1 of your onboarding assistant? Start with [Answer Basic Questions](/user-guide/getting-started/tutorials-common-first-agents/employee-onboarding-assistant/answer-basic-questions).
