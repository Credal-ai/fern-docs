...
Create an [action](/user-guide/platform/governed-actions/overview) that can post Jira tickets based on user feedback. This action should:
...
Note: Ensure you have proper [permissions](/user-guide/platform/governed-actions/credentials-and-security) set up for Jira actions. Only use write-actions like creating Jira tickets in public projects where appropriate.
...
4. Ask a Credal admin to [publish this Agent and attach it as an Action](/user-guide/platform/agent-builder/configuration/agent-collaboration) to your "The Orienteer" agent.
