...
Attach both the Company Information Domain Specialist and Web Searcher as [Actions](/user-guide/platform/agent-builder/configuration/agent-collaboration) to The Orienteer agent. Update the instructions prompt to:
