...
1. Click on the "[Actions](/user-guide/platform/governed-actions/overview)" tab in the right side panel
...
Continue to [Searching Internal and External Knowledge](/user-guide/getting-started/tutorials-common-first-agents/employee-onboarding-assistant/searching-internal-and-external-knowledge) to add internal knowledge search and external web research to The Orienteer.
