...
We are going to use a combination of data sources, prompting, and actions to accomplish this. If you are a beginner or want a refresher on Agent building, see our [guide](/user-guide/platform/agent-builder/configuration/setting-up-an-agent) for starters.

We can start by creating the Agent and giving it a name and description.
