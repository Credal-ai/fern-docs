...
![Create IT Assistant](/docs/assets/it-security-use-cases/create-IT-security-assistant.png)
![IT Background Prompt](/docs/assets/it-security-use-cases/IT-security-prompt.png)
...
![Create Employee Assistant](/docs/assets/it-security-use-cases/employee-assistant-create.png)
![Employee Background Prompt](/docs/assets/it-security-use-cases/employee-bg-prompt.png)
...
![Deploy IT Agent to Employee Assistant](/docs/assets/it-security-use-cases/deploy-it-agent-to-employee-assistant.png)
![Employee Assistant Can Call IT Agent](/docs/assets/it-security-use-cases/employee-assitant-can-call-it-agent.png)
