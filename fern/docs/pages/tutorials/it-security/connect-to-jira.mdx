...
To ensure that you are connected to Jira, go to the "[Action Provider](/user-guide/platform/agent-builder/configuration/add-connectors/actions)" page and connect to Jira.
