...
To ensure that you are connected to Jira, go to the [Actions](/user-guide/platform/agent-builder/configuration/add-connectors/actions) page and connect to Jira.
...
Continue to [Publish to Slack](/user-guide/getting-started/tutorials-common-first-agents/it-security-assistant/publish-to-slack) to make the IT assistant available where your users already ask for help.
