...
Now we can go to the Actions tab on the left hand side panel and hit "Create new Action." Type in "jira" in the search bar to filter down to Jira actions, then hit "Bulk create Jira actions." Now select the following templates:
