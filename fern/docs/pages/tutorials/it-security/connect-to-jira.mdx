...
To ensure that you are connected to Jira, go to the "[Action Provider](/user-guide/platform/integrations/data-sources-action-providers)" page and connect to Jira.
